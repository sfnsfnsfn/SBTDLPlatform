...
def convert_image_to(
    ...
    """
    image = ImageReader.read(read_path, output_color="BGR")
...
def read_large_image(image_path: str):
    ...
    try:
        ...
        img_cv2 = ImageReader.read(image_path, output_color="BGR")
        ...
        image0 = ImageReader.read(image_path)
        use_cv2 = False
...
def read_image(image_path: str):
    ...
    """
    # read image
    image = ImageReader.read(image_path, output_color="BGR")
...
def read_image_as_pil(
    ...
    if isinstance(image, Image.Image):
        ...
        try:
            ...
            image_sk = ImageReader.read(image)
