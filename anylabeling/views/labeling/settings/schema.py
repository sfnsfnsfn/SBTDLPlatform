...
def _settings_translation_markers() -> None:
    ...
    QCoreApplication.translate("SettingsDialog", "Label Area Opacity")
...
def _non_shortcut_fields() -> list[SettingField]:
    return [
        ...
        SettingField(
            "shape.fill_opacity",
            QT_TRANSLATE_NOOP(
                SETTINGS_TRANSLATION_CONTEXT, "Label Area Opacity"
            ),
            "int",
            "Shape",
            "Drawing Style",
            ...
            description=QT_TRANSLATE_NOOP(
                SETTINGS_TRANSLATION_CONTEXT,
                "Control the fill opacity used when rendering label areas.",
            ),
        ),
        SettingField(
            "shape.vertex_fill_color",
