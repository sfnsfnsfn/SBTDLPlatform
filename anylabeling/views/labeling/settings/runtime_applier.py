...
class SettingsRuntimeApplier:
    ...
    def apply_shape_style(self, key: str) -> None:
        ...
        Shape.fill_color.setAlpha(self._widget._shape_fill_opacity())
        ...
        if key == "shape.fill_opacity":
            self._widget._refresh_shape_fill_opacity()
            return
        ...
        if key in color_key_map:
            ...
            for shape in self._widget.canvas.shapes:
                ...
                if key == "shape.fill_color":
                    color.setAlpha(self._widget._shape_fill_opacity())
                setattr(shape, color_key_map[key], color)
        self._widget.canvas.update()
