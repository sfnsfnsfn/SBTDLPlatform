...
# ============================================================================
# This module is preserved for backward compatibility with existing callers
# (e.g., anylabeling/services/auto_training/ultralytics/general.py).
#
# Platform code SHOULD use XLabelCodec from:
#     anylabeling.platform.application.annotation_service
# instead of importing LabelConverter directly.
#
# The XLabelCodec implements the AnnotationCodec Protocol defined in:
